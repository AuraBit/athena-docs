...
| [image-promotion-and-rollback](image-promotion-and-rollback.md) | gated promotion + one-revert rollback | CD-04/D-30 | pending (scheduled with Phase 3 verify-work) |
